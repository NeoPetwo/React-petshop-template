...
export default class AdminRegisterAdmin extends React.Component {
  ...
  //Requisição para criar um novo admin
    ...
    let res = await axios({
      ...
      data: {
        ...
        address: this.state.address,
				admin: true //This registration is for new admins
      }
		});
        ...
        <div class="adm_registration">
          ...
          <div class="form-popup" id="admin">
              <form action="#" class="form-container">
                  ...
                  <label>Address</label>
                  <input type="text" placeholder="Type here your address" name="" onChange={this.handleChangeAddress}/>								
